...
type_to_module_mapping = {
    ...
    hf_models.qwen2.modeling_qwen2.Qwen2Model: qwen_type_to_module_mapping,
    hf_models.qwen2.modeling_qwen2.Qwen2ForCausalLM: qwen_lm_type_to_module_mapping,
...
type_to_dimension_mapping = {
    ...
    hf_models.qwen2.modeling_qwen2.Qwen2Model: qwen_type_to_dimension_mapping,
    hf_models.qwen2.modeling_qwen2.Qwen2ForCausalLM: qwen_lm_type_to_dimension_mapping,
